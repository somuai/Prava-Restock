...
shape of workload) drives the routine loop — checking triggers, sequencing tool calls. gpt-5.6-sol is reserved for the two moments needing real judgment: writing the notify_user
...
# copy generated by gpt-5.6-sol; the trigger decision itself stays on gpt-5.4-mini
